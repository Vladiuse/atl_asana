...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_text_1: str = (
        "У тебя тоже что-то внезапно закололо в области груди сегодня? Отмена паники! "
        "Это все шалости Святого Валентина, ведь сегодня он традиционно расчехлил "
        "свой колчан и пронзил твое сердечко!💘\n\n"
        "Запись к кардиологу рекомендуем не отменять, чекап — тоже важно\n\n"
        "Джоэл считал, что 14 февраля — это праздник, который придумали компании, "
        "производящие поздравительные открытки, чтобы заставить людей чувствовать себя паршиво.\n\n"
        "Мы же с ним не согласны категорически, и подготовили для тебя самые лучшие открытки "
        "для твоего друллеги, а ещё — этот бот, который поможет тебе признаться в твоей "
        "любви совершенно анонимно, без подписок, и смс 🥹\n\n"
        "🥰 Анонимно.\n"
        "☕️ Без объяснений.\n"
        "😊 Без «это я, если что», но можно и с ним!\n\n"

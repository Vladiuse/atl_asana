...
from asana.webhook_actions.registry import WEBHOOK_ACTION_REGISTRY
...
class WebhookHandlerRegistrySynchronizer:
    ...
    def synchronize(self) -> dict[str, int]:
        ...
        sender_names_register = list(WEBHOOK_ACTION_REGISTRY)
        ...
        new_created = 0
        updated = 0
        for sender_name, sender_info in WEBHOOK_ACTION_REGISTRY.items():
            try:
